...
const INPUT_TOUR = [
  { sel: '[data-tour="input-text"]', title: 'まず、自己紹介をここに貼ります', text: '好きなこと・得意なこと・これまでの経験を。箇条書きでも、プロフィールの文章まるごとでも大丈夫です。出したいサービスが決まっている方も、同じ欄に一緒に書いてください。' },
  ...
  return (
    <div className="p-6 md:p-10 lg:p-12 h-full flex flex-col">
      ...
      <p className="text-sm text-stone-500 leading-relaxed mb-5">
        ...
        出したいサービスがもう決まっている方も、この欄に一緒に書いてください。20案の中に、その案を含めて出します。
      </p>
