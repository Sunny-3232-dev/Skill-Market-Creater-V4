...
| `--gradient-brand` | orange-400 → rose-500 → purple-600 | **ワードマーク「Creator Pro」のみ**（ボタン・見出しには使わない。AIツール然とした見た目を避ける） |
...
### 禁止事項
- グラデーションはワードマーク以外に使わない（ボタン・バッジ・枠線・アイコン・見出し）
- キラキラ（✨）系のアイコンを使わない。作り直しは回る矢印、AI編集はペンの線画
...
| クラス | 見た目 | 用途 | 画面内の数 |
| --- | --- | --- | --- |
| `.btn-primary` | ローズ600の単色ピル + rose影 | その画面の最重要アクション（生成する・出品画面へ） | **最大1** |
...
| クラス | 用途 |
| --- | --- |
| `.text-brand-gradient` | ワードマーク「Creator Pro」のみ |
