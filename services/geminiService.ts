...
■ 主役
・このサービス固有のモチーフを1つ、参考情報から決めて大きく描く（道具・場面・成果物・相手のどれか）。人物にするか物にするかは内容で決める。動物・マスコットは使わない
...
・提供者の人物か、サービス固有のモチーフか、どちらか1つを内容で選ぶ。人物なら半身で、前向きな一動作（指をさす・道具を持つ・画面を示す）。動物・マスコットは使わない。
